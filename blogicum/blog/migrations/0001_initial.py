# Generated by Django 4.2.9 on 2025-06-05 21:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(default=datetime.datetime(2025, 6, 6, 0, 9, 14, 714789), help_text='Если установить дату и время в будущем — можно делать отложенные публикации.', verbose_name='Дата и время публикации')),
                ('title', models.CharField(max_length=256, verbose_name='Заголовок')),
                ('comment_count', models.PositiveIntegerField(default=0, verbose_name='Счётчик комментариев')),
