# Generated by Django 4.2.9 on 2025-06-07 12:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=256, verbose_name='Заголовок')),
                ('pub_date', models.DateTimeField(default=datetime.datetime(2025, 6, 7, 15, 8, 42, 930124), help_text='Если установить дату и время в будущем — можно делать отложенные публикации.', verbose_name='Дата и время публикации')),
